...
const PhotographerLogin = () => {
 ...
 w-screen h-screen"
    >
      ...
      {/* Form  */}
      <div className="w-full relative top-[270px]">
        <form
        ...
        >
          ...
          <div className="w-full inputBox">
            <label
              htmlFor="email"
              id="email"
              className="font-syne text-[25px] font-medium p-3"
            >
              Email
            </label>
...
"
            >
              <input
                ...
                className="font-syne relative left-5 text-[25px] font-medium w-[calc(100%-40px)] outline-none focus:outline-none focus:ring-0"
