  ...
  return (
    ...
    >
      <div className="w-full max-w-[412px] flex items-center justify-center gap-[14px]">
        <div className="bg-white h-[56px] px-5 py-[10px] w-full flex items-center justify-between rounded-[30px] text-2xl font-syne gap-[10px]">
          <div
        ...
        <button onClick={() => navigate(loginState)} className='w-[60px] h-[48px] bg-white rounded-full flex items-center justify-center'>
