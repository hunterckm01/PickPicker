...
const Home = () => {
  ...
  return (
    <>
      {/* Home */}
      <section class="mt-[12px] sm:mt-10 px-6" id="home">
        <div class="bg-gradient-to-br from-[#e9ceff] to-[#fad0fc] rounded-3xl shadow-2xl py-6 px-4 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-14 depth">
          <div class="bg-white/80 glass rounded-2xl p-4 sm:p-6 w-72 sm:h-60 flex flex-col justify-between shadow-inner text-gray-800 text-base relative border-2 border-pink-200">
            <div class="absolute -top-4 left-4 text-xs bg-pink-500 px-3 py-1 rounded-full font-bold shadow  ">
              Photo Selector
            </div>
            <div class="flex flex-col items-center mt-2 sm:mt-8">
              <img
                src="https://img.icons8.com/ios-filled/100/e954b5/camera--v1.png"
                class="w-8 h-8 sm:w-16 sm:h-16 mb-2"
                alt="Event Photo"
              />
              <div class="bg-pink-200 p-2 sm:p-0 w-32 sm:w-40 h-8 rounded-full text-center text-pink-700 font-bold flex items-center justify-center shadow text-sm sm:text-lg">
                Select Customer
              </div>
            </div>
            <div class="bg-gradient-to-tr from-pink-400 to-purple-300 h-12 sm:h-28 w-full mt-2 sm:mt-6 rounded-xl shadow-lg flex items-center justify-center">
          ...
          <div class="text-center lg:text-left max-w-xl">
            <h1 class="text-xl sm:text-3xl lg:text-5xl font-extrabold text-gray-900 leading-tight drop-shadow">
              India's Simplest <span class="text-purple-700">Online</span>
              <br />
              Photo Selection Software
            </h1>
            <p class="mt-6 text-xs sm:text-md lg:text-lg text-gray-700">
            ...
            <button
              class="mt-4 sm:mt-8 px-6 py-2 sm:px-8 sm:py-3 text-sm sm:text-lg font-semibold bg-gradient-to-r from-purple-700 to-pink-500 text-white rounded-full hover:duration-200 hover:scale-105 transition-shadow shadow-xl"
      ...
      <section class="mt-14 px-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 bg-gradient-to-r from-[#f4c4f3] to-[#fc67fa] text-white text-center px-4 py-4 sm:py-12 rounded-3xl shadow-2xl depth">
          <div class="flex sm:flex-col justify-between items-center gap-3 bg-white/10 rounded-2xl p-6  shadow-lg hover:scale-105 transition">
            ...
            <div className="flex flex-col">
              ...
              <p class="text-xl sm:text-3xl font-extrabold tracking-wider">
                2200+
              </p>
            </div>
          </div>
          <div class="flex sm:flex-col justify-between items-center gap-3 bg-white/10 rounded-2xl p-6 shadow-lg hover:scale-105 transition">
            ...
            <p class="text-xl sm:text-3xl font-extrabold tracking-wider">2200+</p>
            </div>
          </div>
          <div class="flex sm:flex-col justify-between items-center gap-3 bg-white/10 rounded-2xl p-6 shadow-lg hover:scale-105 transition">
      ...
      {/* <!-- How to Use --> */}
      <section class="mt-6 sm:mt-12 px-6" id="assist">
        <h2 class="text-2xl md:text-3xl font-extrabold mb-6 sm:mb-8 text-center text-purple-800 tracking-tight">
          How to Use?
        </h2>
      ...
      {/* <!-- Pricing --> */}
      <section class="mt-10 sm:mt-12 lg:mt-16 px-6 text-center" id="pricing">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 justify-items-center">
          {/* <!-- Free Plan --> */}
          <div class="relative bg-gradient-to-br from-[#e3a8ff] to-[#f6f2ff] p-6 sm:p-10 rounded-3xl shadow-2xl w-80 depth transform hover:scale-105 transition flex flex-col items-center border-4 border-white">
            ...
            <h3 class="text-xl sm:text-2xl font-bold mb-2 mt-8 text-purple-700">
              Free Plan
            </h3>
            <span class="inline-block bg-green-200 text-green-800 text-xs font-bold px-3 py-1 rounded-full mb-4">
              Best for Starters
            </span>
            <p class="text-sm sm:text-lg text-gray-800 mb-4 sm:mb-6">
              You can access everything we offer
            </p>
            <div class="text-3xl sm:text-4xl font-extrabold text-purple-700 mb-2">₹0</div>
            <button class="mt-2 sm:mt-4 px-6 py-2 bg-purple-700 text-white rounded-full font-semibold shadow-md hover:bg-purple-800 transition">
              Get Started
            </button>
          </div>
          {/* <!-- Premium Plan --> */}
          <div class="relative bg-gradient-to-br from-[#fcb0f1] to-[#fad0fc] p-6 sm:p-10 rounded-3xl shadow-2xl w-80 depth transform hover:scale-105 transition flex flex-col items-center border-4 border-pink-300">
            <div class="absolute -top-6 left-1/2 -translate-x-1/2 bg-white rounded-full p-3 shadow-lg">
              <img
            ...
            <h3 class="text-xl sm:text-2xl font-bold mb-2 mt-8 text-pink-700">
              Premium Plan
            </h3>
            <span class="inline-block bg-pink-200 text-pink-800 text-xs font-bold px-3 py-1 rounded-full mb-4">
              Most Popular
            </span>
            <p class="text-xs sm:text-lg text-gray-800 mb-4 sm:mb-6">So why you looking for it</p>
            <div class="text-3xl sm:text-4xl font-extrabold text-pink-700 mb-2">₹999</div>
      ...
      {/* <!-- Final CTA --> */}
      <section class="mt-10 sm:mt-20 px-6 text-center" id="reachus">
        <div class="bg-gradient-to-tr from-pink-400 to-purple-500 text-white p-10 rounded-3xl shadow-2xl w-full max-w-2xl mx-auto depth flex flex-col items-center">
          ...
          class="px-8 py-3 bg-white text-pink-700 font-bold text-lg rounded-full mb-4 shadow-lg hover:scale-105 transition">
            Try for Free
          </button>
